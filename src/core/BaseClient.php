 ...
 * @property \AlibabaOpen\AlibabaCross app
 */
class BaseClient
{
    /**
     ...
     * @return bool|string
     */
    public static function curlRequest($base_url, $query_data, $method = 'get', $ssl = true, $exe_timeout = 20, $conn_timeout = 20, $dns_timeout = 3600)
    {
        $method = strtolower($method);
        $ch     = curl_init();
        if ($method == 'get') {
